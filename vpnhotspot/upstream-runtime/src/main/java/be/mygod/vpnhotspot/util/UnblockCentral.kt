 ...
 */
private val SoftApCallbackClass by lazy { Class.forName("android.net.wifi.WifiManager\$SoftApCallback") }
    ...
    val WifiManager_SoftApCallbackProxy by lazy {
        ...
        try {
            clazz.getDeclaredConstructor(WifiManager::class.java, Executor::class.java,
                SoftApCallbackClass, Int::class.javaPrimitiveType).run {
                isAccessible = true
                this to false
            }
